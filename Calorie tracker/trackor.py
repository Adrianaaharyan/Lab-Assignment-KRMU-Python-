...
print("")
print("A simple way to have control on what you eat — log your meals, see your total calories, and make sure you’re meeting your daily goals.\n")

# Task 2: Input and collect Data 
meal_name = []
meal_calories = []

num_meals = int(input("How many meals would you enter today? "))

for i in range(num_meals):
    meal = input(f"\nEnter your meal name #{i+1}: ")
    calories = float(input(f"Enter amount of calories for {meal}: "))
    meal_name.append(meal)
    meal_calories.append(calories)
    
# Task 3: calculating your Calories
